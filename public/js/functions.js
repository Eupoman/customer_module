    ...
    $.martanianShowQuotePopup = function( type ) {    
        ...
        setTimeout( function() {
            ...
            if( mode == 'fixed' ) {
                ...
                $( '#quote-popup #quote-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50%', 'marginTop': - ( selectedQuoteForm.height() / 2 ), 'position': 'fixed' });//, 'height': selectedQuoteForm.height()
            }
                ...
                if( windowWidth > 932 ) {
                    ...
                    $( '#quote-popup #quote-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'position': 'absolute' }); //, 'height': selectedQuoteForm.height()
                    selectedQuoteForm.children( '.quote-form-background' ).css({ 'height': selectedQuoteForm.height() });
                }
                
                else {
                    
                    if( windowWidth > 582 ) $( '#quote-popup #quote-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'position': 'absolute' }); //'height': selectedQuoteForm.height(),
                    else {
                    
                        $( '#quote-popup #quote-popup-content' ).addClass( 'bounceInDown' ).css({ 'top': '50px', 'marginTop': '0px', 'position': 'absolute' }); //, 'height': selectedQuoteForm.height() + $( '#quote-popup-tabs' ).height() + 50
                    }
                }
            }
    ...
    */                
    ...
    $( '#quote-popup-tabs li' ).click( function() {
        ...
        if( !$( this ).hasClass( 'active' ) ) {
            ...
            if( mode == 'fixed' || windowWidth > 932 ) {
                newQuoteForm.children( '.quote-form-background' ).animate({ 'height': newQuoteForm.height() }, 300 );}
            ...
            setTimeout( function() {
                ...
                if( mode == 'fixed' ) $( '#quote-popup #quote-popup-content' ).animate({  'marginTop': - ( newQuoteForm.height() / 2 ) }, 300 );//'height': newQuoteForm.height(),
                else {
                
                    if( windowWidth > 582 ) $( '#quote-popup #quote-popup-content' ).animate({ 'height': 'auto'}, 300 ); // newQuoteForm.height()
                    else {
                    
                        $( '#quote-popup #quote-popup-content' ).animate({ 'height': 'auto' }, 300 ); //newQuoteForm.height() + $( '#quote-popup-tabs' ).height() + 50
                    }
                }
    ...
    */      
    ...
    $.martanianConfigureValueSlider = function() {
        $( '#quote-popup .quote-form .slider, section.quote-forms .slider' ).each( function() {
            ...
            // $( this ).noUiSlider();
            if($( this ).hasClass('noUi-background')) {
    ...
    $( '.send-quote' ).click( function(e) {
        ...
        quoteForm.find( '.quote-form-element' ).each( function( fieldID ) {
            ...
            if( $( this ).hasClass( 'checkbox' ) ) {
                ...
                if( ( $( this ).is( 'input' ) && fieldValue == '' ) || ( $( this ).is( 'select' ) && fieldValue == '-' ) ) {
                    ...
                    $( this ).removeClass( 'filledElement' );
                    $( this ).addClass( 'error' );                                                                         
                } else {
                    if ($(this).hasClass('quote-form-client-name')) {
                        if (!validateName($(this).val())) {
                            ...
                            $( this ).addClass( 'filledElement' );
                            $( this ).removeClass( 'error' );
                        }
                    } else if ($(this).hasClass('quote-form-client-email')) {
                    ...
                    } else if ($(this).hasClass('quote-form-client-phone')) {
                    ...
                    } else if ($(this).hasClass('quote-form-client-rut')) {
        ...
        if( errorFound == false ) {
            ...
            if(insuranceType == "travel-insurance") {   
                var members = $(".quote-form-members").val();
                var ages = $('.quote-form-ages').val();
                location.href = "filter/travel?members=" + members + "&ages=" + ages;
                return false;
            } else if(insuranceType == "life-insurance") {   
                location.href = "filter/life";
                return false;
            } else if(insuranceType == "soap-insurance") {   
                location.href = "filter/life";
                return false;
            } else if(insuranceType == "house-insurance") {
                var rut = $(".quote-form-house-rut").val();
                var email = $(".quote-form-house-email").val();
                var number = $(".quote-form-house-number").val();
                location.href = "filter/house?rut=" + rut + "&number=" + number + "&email=" + email;
                return false;
            } else if(insuranceType == "car-insurance") {   
                window.location = "nextstep/auto";
                return false;
            }  else if(insuranceType == "moto-insurance") {   
                window.location = "nextstep/moto";
                return false;
            } else if(insuranceType == "rcp-insurance") {   
                window.location = "filter/rcp";
                return false;
            } else {
                window.location = "nextstep/auto";
                return false;
        ...
        if( $( '#quote-popup #quote-popup-background' ).css( 'display' ) == 'block' ) {
            ...
            setTimeout( function() {
                ...
                if( mode == 'fixed' ) {
                    ...
                    selectedQuoteForm.children( '.quote-form-background' ).css({ 'height': selectedQuoteForm.height() });
                    $( '#quote-popup #quote-popup-content' ).css({ 'top': '50%', 'marginTop': - ( selectedQuoteForm.height() / 2 ), 'position': 'fixed' }); //'height': selectedQuoteForm.height(),
                }
                    ...
                    if( windowWidth > 932 ) {
                        ...
                        if( windowWidth > 582 ) $( '#quote-popup #quote-popup-content' ).css({ 'top': '50px', 'marginTop': '0px',  'position': 'absolute' }); //'height': selectedQuoteForm.height(),
                        else {
                        
                            $( '#quote-popup #quote-popup-content' ).css({ 'top': '50px', 'marginTop': '0px', 'position': 'absolute' }); //, 'height': selectedQuoteForm.height() + $( '#quote-popup-tabs' ).height() + 50
                        }
                    }
                } 
